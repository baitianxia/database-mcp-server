...
- 文件：`dist/database-mcp-server-0.2.7-windows-x64.zip`
- 外置校验：同目录的 `database-mcp-server-0.2.7-windows-x64.zip.sha256`；发布清单中的 `source.revision` 指向发布移动重试修复提交 `f93a323`。
